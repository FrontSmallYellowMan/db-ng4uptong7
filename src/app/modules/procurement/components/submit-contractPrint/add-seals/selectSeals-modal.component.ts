...
import { sealsQuery,SelectSealsService } from '../../../services/purchase-contractInfo.service';

export class PageNo { }

@Component({
  templateUrl: './selectSeals-modal.component.html',
  styleUrls: ['./add-seals.component.scss']
})
export class SelectSealsModalComponent implements OnInit{
  ...
  public sealsList = [{},{}];
    constructor(
        ...
        private scService: SelectSealsService
    ){}
    //初始化下拉框数据
