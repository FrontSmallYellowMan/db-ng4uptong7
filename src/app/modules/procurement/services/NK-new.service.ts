export class PurchaseOrderObj {//采购订单-整体数据结构
  ...
  */
  ...
  public OrderType: string = "NK";//采购订单类型（NB）
  ...
  public RateValue: number = 0;//税率值，两位小数
...
/*————————————————————————————————————————————— 以下是需要的其他结构 ————————————————————————————————————————————*/
export class NKOrderMessage {//NK单采购订单-采购信息-数据结构
  public TemplateID = null;//模板id
  public CompanyName: string = "";//公司名称
  public CompanyCode: string = "";//公司代码
  public FactoryCode: string = "";//工厂编号
...
export class NKNewPersonElement {//预审人员的 单位信息 (在暂存情况下)
