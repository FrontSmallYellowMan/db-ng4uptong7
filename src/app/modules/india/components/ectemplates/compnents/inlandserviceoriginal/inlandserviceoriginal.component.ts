...
@Component({
  selector: 'db-inlandserviceoriginal',
  templateUrl: './inlandserviceoriginal.component.html',
  styleUrls: ['./inlandserviceoriginal.component.scss','../../scss/ec-template.component.scss']
})
export class InlandserviceoriginalComponent implements OnInit {
