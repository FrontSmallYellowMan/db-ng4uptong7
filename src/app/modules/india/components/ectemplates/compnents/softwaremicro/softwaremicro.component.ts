...
@Component({
  ...
  templateUrl: './softwaremicro.component.html',
  styleUrls: ['./softwaremicro.component.scss'],
  providers: [ ScTemplateService ],
  encapsulation: ViewEncapsulation.None
})
export class SoftwareMicroComponent implements OnInit {
  ...
  public DeliveryMode: Array<any> = [{ id: '1', text: '1' }, { id: '2', text: '2' }];
  // public sellerInfo: SellerInfo;//卖方信息
  // public selectedBuyer: BuyerInfo = new BuyerInfo();
  ...
  onInitData() {
    ...
    this.selectInfo.DeliveryMode = this.DeliveryMode;
  ...
  onSaveHandle() {
    ...
    this.selected.DeliveryMode.length > 0? 
    this.formData.BaseData.DeliveryMode = this.selected.DeliveryMode[0]["text"]: 
    this.formData.BaseData.DeliveryMode = null;
    let utilityclass = new EcContractCommonClass();
    this.formData.BaseData.DeliveryModeDesc = utilityclass.returnTitleByDeliveryMode(this.formData.BaseData.DeliveryMode.toString());
  ...
  oncheckInfo() {
    ...
    if (this.formData.BaseData.DeliveryMode == "2" && this.formData.BaseData.DeliveryAddressType == 1) {
      //清除多送货地址
    ...
    } else if (this.formData.BaseData.DeliveryMode == "2" && this.formData.BaseData.DeliveryAddressType == 2) {
      //单送货地址清除
  ...
  initFormHandle(data) {
    ...
    if (this.formData.BaseData.DeliveryMode) {
      this.selected.DeliveryMode = [{id:this.formData.BaseData.DeliveryMode,text:this.formData.BaseData.DeliveryMode}];
    } else {
      this.selected.DeliveryMode = [{id:"1",text:"1"}];
    }
    ...
    if (this.formData.BaseData.ContractTime) {
      ...
      this.formData.BaseData.ContractTime = moment(new Date()).format("YYYY-MM-DD");
    }
