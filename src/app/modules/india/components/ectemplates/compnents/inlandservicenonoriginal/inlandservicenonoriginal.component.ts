...
@Component({
  selector: 'db-inlandservicenonoriginal',
  templateUrl: './inlandservicenonoriginal.component.html',
  styleUrls: ['./inlandservicenonoriginal.component.scss','../../scss/ec-template.component.scss']
})
export class InlandservicenonoriginalComponent implements OnInit {
